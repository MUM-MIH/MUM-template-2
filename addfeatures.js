...
window.addEventListener("load", function () {
 ...
 //add igraduate survey ad
  ...
  if (
    ...
    $("h3.sectionname:last").after(
      '<div class="central-info"> <h2>Breaches of Academic Integrity</h2> <p>At Monash University, we take academic integrity very seriously. A breach of academic integrity includes, but is not limited to: plagiarism, collusion, contract cheating, and inappropriate use of generative artificial intelligence. In simple terms, plagiarism is the act of submitting work that is not your own or that contains the work of others without proper credit given to them. In academic work, this would include:</p> <ul> <li>Using the ideas or words of another without proper referencing or citations</li> <li>Incomplete or inaccurate citation and referencing</li> <li>Submitting someone else\'s work as your own</li> <li>Working on an individual assignment as a group (where multiple individuals contribute to the work but it is submitted as an individual assignment - this is called collusion)</li> </ul> <p><br>This list is not exhaustive. <a href="https://www.monash.edu/students/study-support/academic-integrity" target="_blank">For information on Monash University\'s policies on academic integrity, please visit this website.</a> Submitted work that is suspected of plagiarism will be dealt with according to Monash policies and may result in penalties to your grade or other disciplinary action according to <a href="https://www.monash.edu/__data/assets/pdf_file/0005/769640/student-discipline-guidelines-26-Feb-2018.pdf" target="_blank">Monash Student Discipline Guidelines</a>.<br><br></p> <h2>Responsible and Ethical use of Generative AI</h2> <p>When generative artificial intelligence is used by students as part of assessment, it is expected to be used with honesty and in a manner that is responsible and ethical. Inappropriate use of generative artificial intelligence is when a student uses generative artificial intelligence tools to produce new work and submits it as their own original work. Specifically, this can occur when a student:</p> <ul> <li>uses generative artificial intelligence tools when the chief examiner has specified in the assessment documentation in the learning management system that it cannot be used; or</li> <li>fails to appropriately acknowledge the use of generative artificial intelligence tools in the creation of work submitted for assessment. </li> </ul> <br><p>Learn how to acknowledge the use of generative AI including by citation and referencing on <a href="https://www.monash.edu/learnhq/build-digital-capabilities/create-online/acknowledging-the-use-of-generative-artificial-intelligence" target="_blank">Learn HQ</a>.<a href="https://publicpolicydms.monash.edu/Monash/documents/1935762" target="_blank"> More information on Student Academic Integrity Procedure</a>.</p> <br><h2>Turnitin</h2> <p>All essay-format assignments submitted here will go through a software called Turnitin which detects instances of plagiarism. You will be prompted to submit your essay to Turnitin prior to submission. This is a good chance for you to check that your citations and referencing are in order as well. Turnitin will also produce a similarity score which indicates how much of the submitted work is similar to other published work. What is an acceptable similarity score may differ from discipline to discipline. For this reason, check with your Unit Coordinator before submitting assignments. NOTE: A low similarity score does not necessarily indicate that no plagiarism has occured. You should still check to make sure that all your references and citations are accurate and no unintentional plagiarism has occurred.<br><br></p> <h2>Extensions and late submissions</h2> <p>Late submissions will be subject to a penalty of 10% (of the maximum possible mark for the assessment item) for every day and part thereof that the work is late. Submissions more than seven days late will receive a mark of zero.<a href="https://www.monash.edu/__data/assets/pdf_file/0003/2300925/Assessment-Regime-Procedure.pdf" target="_blank"> More information on assessment procedure</a>.</p> <p><span>If you need more time, you may request a short extension of two calendar days without giving a reason on your first application for a particular unit. No supporting documents are needed for any short extension. Extension requests for longer than two days require an application for Special Consideration with supporting documents. <a href="https://www.monash.edu/students/admin/exams/changes/special-consideration" target="_blank">More information on Special Consideration.</a> Click here to <a href="https://sors.monash.edu.my/sites/student-online-forms/course" target="_blank">apply for special consideration</a>.<br><br></p> <h2>Appeals for Review or Remark</h2> <p>Except for fail grades on major assessment tasks (which are always double marked), students do not have an automatic right to have an assessment remarked. Students can request a correction of their assessment mark due to an error, e.g. if an incorrect late penalty has been applied or due to a miscalculation. A student cannot request a correction of their mark on the basis that they do not agree with the mark, or that they perceive the feedback received to be inadequate. Requests for remark must also be made within 10 working days of receiving the assessments during the teaching period. Requests for remark of final assessments must be made within six weeks of recieving the grade.<a href="https://forms.monash.edu/special-consideration" target="_blank"> More information on marking procedure</a>. </div>' );
  } else {
